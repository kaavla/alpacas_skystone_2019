...
@Autonomous(name="AutoBlueTwoSKYOnFOUNDATION", group="JARVIS")

public class BlueTwoSKYOnFOUNDATION extends JARVISAutonomousBase{
    ...
    public void getStone()
    {
        ...
        myEncoderDrive(JARVISAutonomousBase.Direction.STRAFE_RIGHT, DRIVE_SPEED,4, 5.0, JARVISAutonomousBase.SensorsToUse.NONE);
        sleep(100);
    }
    ...
    public void myDetectionRun(double timeoutS)
    {
        ...
        if (opModeIsActive() && !isStopRequested()) {
            ...
            myEncoderDrive(JARVISAutonomousBase.Direction.STRAFE_LEFT, 0.2, 50, 5.0, JARVISAutonomousBase.SensorsToUse.USE_DISTANCE_LEFT);
            ...
            if (myDetectSkystone(JARVISAutonomousBase.SideToUse.USE_LEFT, 10) == false) {
                myEncoderDrive(JARVISAutonomousBase.Direction.FORWARD, 0.1, 24, 10.0, JARVISAutonomousBase.SensorsToUse.USE_COLOR_LEFT);
            ...
            getStone();
            myEncoderDrive(JARVISAutonomousBase.Direction.BACKWARD, DRIVE_SPEED, 24 + 35 + strafe_back_previous, 10.0, JARVISAutonomousBase.SensorsToUse.NONE);

            //drop the skystone
            //drop the skystone
            myEncoderDrive(JARVISAutonomousBase.Direction.STRAFE_LEFT, DRIVE_SPEED,2, 5.0, JARVISAutonomousBase.SensorsToUse.NONE);
            sleep(100);
            releaseStone();
            sleep(100);
            ...
            if (strafe_back_previous < 12) {
                ...
                myEncoderDrive(JARVISAutonomousBase.Direction.FORWARD, 0.6, 24 + 44 + strafe_back_previous, 10.0, JARVISAutonomousBase.SensorsToUse.NONE);
                ...
                myEncoderDrive(JARVISAutonomousBase.Direction.STRAFE_LEFT, 0.2,24, 5.0, JARVISAutonomousBase.SensorsToUse.USE_DISTANCE_LEFT);

                //move forward while sensing using the color sensor
                //stop whenever the color sensed is not yellow, but black (skystone)
                //add the extra distance traveled using the color sensor to strafe_back
                myEncoderDrive(JARVISAutonomousBase.Direction.FORWARD, 0.1, 20, 5.0, JARVISAutonomousBase.SensorsToUse.USE_COLOR_LEFT);
                ...
                myEncoderDrive(JARVISAutonomousBase.Direction.BACKWARD, 0.5, 24 + 52 + strafe_back_previous + strafe_back, 10.0, JARVISAutonomousBase.SensorsToUse.NONE);
                ...
                //Drive back to collect the second stone
                myEncoderDrive(JARVISAutonomousBase.Direction.FORWARD, 0.6, 24 + 52 + strafe_back_previous, 10.0, JARVISAutonomousBase.SensorsToUse.NONE);
                ...
                //drive to other side and drop the stone
                myEncoderDrive(JARVISAutonomousBase.Direction.BACKWARD, 0.5, 24 + 58 + strafe_back_previous + strafe_back, 10.0, JARVISAutonomousBase.SensorsToUse.NONE);
            ...
            myEncoderDrive(JARVISAutonomousBase.Direction.FORWARD, 0.6, 24 + 15, 10.0, JARVISAutonomousBase.SensorsToUse.NONE);
