...
@Autonomous(name="AutoRedSkyOnFoCORNER", group="JARVIS")

public class RedSkyOnFoCORNER extends JARVISAutonomousBase {
    ...
    public void myDetectionRun(double timeoutS)
    {
        ...
        if (opModeIsActive() && !isStopRequested()) {
            ...
            myEncoderDrive(Direction.FORWARD, 0.3, 23, 5.0, JARVISAutonomousBase.SensorsToUse.NONE);
            myEncoderDrive(Direction.STRAFE_RIGHT, 0.2, 50, 5.0, JARVISAutonomousBase.SensorsToUse.USE_DISTANCE_RIGHT);
            ...
            if (myDetectSkystone(JARVISAutonomousBase.SideToUse.USE_RIGHT, 10) == false) {
                myEncoderDrive(Direction.BACKWARD, 0.1, 24, 10.0, JARVISAutonomousBase.SensorsToUse.USE_COLOR_RIGHT);
                ...
                myEncoderDrive(Direction.FORWARD, 0.1, 1, 5.0, JARVISAutonomousBase.SensorsToUse.NONE);
            }
            ...
            myEncoderDrive(JARVISAutonomousBase.Direction.BACKWARD, 0.4, 24 + 80 + strafe_back_previous, 10.0, JARVISAutonomousBase.SensorsToUse.NONE);
            ...
            myEncoderDrive(JARVISAutonomousBase.Direction.FORWARD, 0.6, 24 + 80 - 16 + strafe_back_previous, 10.0, JARVISAutonomousBase.SensorsToUse.NONE);
            correctAngle(); //correct angle to match the reference angle
            ...
            myEncoderDrive(Direction.BACKWARD, 0.1, 20, 5.0, JARVISAutonomousBase.SensorsToUse.USE_COLOR_RIGHT);
            ...
            myEncoderDrive(JARVISAutonomousBase.Direction.BACKWARD, 0.6, 24 + 80 - 16 + strafe_back_previous + strafe_back, 10.0, JARVISAutonomousBase.SensorsToUse.NONE);
            releaseStone();
            correctAngle(); //correct angle to match the reference angle

            //drive under the bridge then strafe towards the bridge so that our alliance also has space to park
            myEncoderDrive(JARVISAutonomousBase.Direction.FORWARD, 0.6, 24 + 24, 10.0, JARVISAutonomousBase.SensorsToUse.NONE);
