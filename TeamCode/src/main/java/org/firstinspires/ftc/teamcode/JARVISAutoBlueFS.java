...
@Autonomous(name="Jarvis Auto Blue FS", group="JARVIS")

public class JARVISAutoBlueFS extends JARVISAutonomousBase{
    ...
    public void myDetectionRun(double timeoutS)
    {
        ...
        if (opModeIsActive() && !isStopRequested()) {
            ...
            if (myDetectSkystone(SideToUse.USE_LEFT, 10) == false) {
                myEncoderDrive(Direction.BACKWARD, 0.1, 24, 10.0, SensorsToUse.USE_COLOR_LEFT);
            ...
            myEncoderDrive(Direction.STRAFE_LEFT, 0.3, 5, 20, SensorsToUse.NONE);
            ...
            myEncoderDrive(Direction.STRAFE_LEFT, 0.3, 3, 20, SensorsToUse.USE_DISTANCE_LEFT_BLD);
            ...
            myEncoderDrive(Direction.STRAFE_RIGHT, 0.3, 3, 20, SensorsToUse.NONE);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            myEncoderDrive(Direction.STRAFE_RIGHT, 0.4, 6, 3, SensorsToUse.NONE);
            ...
            myEncoderDrive(Direction.STRAFE_RIGHT, 0.4, 3, 5, SensorsToUse.NONE);
        }
