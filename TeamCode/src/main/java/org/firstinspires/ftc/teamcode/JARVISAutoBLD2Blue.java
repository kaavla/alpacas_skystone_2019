...
@Autonomous(name="JARVIS Auto Bld 2 Blue", group="JARVIS")
//@Disabled
public class JARVISAutoBLD2Blue extends JARVISAutonomousBase {
    ...
    public void autoBLDFoundation()
    {
        ...
        if (opModeIsActive() && !isStopRequested() )
        {
            ...
            myEncoderDrive(Direction.STRAFE_LEFT, 0.3, 10, 5, SensorsToUse.USE_DISTANCE_LEFT_BLD);
            ...
            myEncoderDrive(Direction.STRAFE_LEFT, 0.2, 4, 5, SensorsToUse.USE_DISTANCE_LEFT_BLD);
        }
