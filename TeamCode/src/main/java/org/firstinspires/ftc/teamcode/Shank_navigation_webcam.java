...
public class Shank_navigation_webcam extends LinearOpMode {
    ...
    private static int targetLocationArray_X[MAX_TARGETS];
    private static int targetLocationArray_Y[MAX_TARGETS];
    private static int targetLocationArray_Z[MAX_TARGETS];
    ...
    public boolean cruiseControl(double standOffDistance) {
        ...
        double L  =((robotX - targetX) * LATERAL_GAIN);

        // Priority #3 Drive forward based on the desiredHeading target standoff distance
        double A  = (((robotY - targetY) - standOffDistance) * AXIAL_GAIN);
    ...
    public boolean targetIsVisible(int targetId) {
        ...
        if ((target != null) && (listener != null) && listener.isVisible()) {
            ...
            targetX = trans.get(0);
            targetY = trans.get(1);
            RobotLog.ii("SHANK", "targetIsVisible - Target - [%2.2f, %2.2f]", targetX, targetY);
            ...
            if (location != null) {
                ...
                RobotLog.ii("SHANK", "targetIsVisible - Robot - [%2.2f, %2.2f, %2.2f]", robotX, robotY,robotBearing );
                ...
                targetBearing = Math.toDegrees(-Math.asin((robotY -targetY)/ targetRange));
