...
@Autonomous(name="JARVIS Auto Bld 2 Red", group="JARVIS")
//@Disabled
public class JARVISAutoBLD2Red extends JARVISAutonomousBase {
    ...
    public void autoBLDFoundation()
    {
        ...
        if (opModeIsActive() && !isStopRequested() )
        {
            ...
            myEncoderDrive(Direction.FORWARD, 0.3, 18, 5, SensorsToUse.NONE);
            //go at a slower speed to make sure we hook on properly
            myEncoderDrive(Direction.FORWARD, 0.1, 7, 5, SensorsToUse.NONE);
            ...
            myEncoderDrive(Direction.BACKWARD, 0.2, 23, 5, SensorsToUse.NONE);
            ...
            sleep(500);
            //Strafe left next to the wall.
            myEncoderDrive(Direction.STRAFE_RIGHT, 0.3, 10, 5, SensorsToUse.USE_DISTANCE_RIGHT_BLD);
            //stop for 3 seconds so the robot is out of the way of the other robots while the
            //autonomous mode is still going on
            sleep(10000);
            //move to the blue tape under the bridge
            myEncoderDrive(Direction.BACKWARD, 0.3, 40, 5, SensorsToUse.NONE);
            //strafe into the wall
            myEncoderDrive(Direction.STRAFE_RIGHT, 0.2, 4, 5, SensorsToUse.USE_DISTANCE_RIGHT_BLD);
        }
